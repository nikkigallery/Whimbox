...
class MapMaskState:
    ...
    nearest_loaded_point_id: str = ""
    nearest_loaded_point_name: str = ""
    nearest_loaded_point_image_x: float | None = None
    nearest_loaded_point_image_y: float | None = None
    nearest_loaded_point_distance: float | None = None
    nearest_loaded_point_delta_image_x: float | None = None
    nearest_loaded_point_delta_image_y: float | None = None
    nearest_loaded_point_delta_screen_x: float | None = None
    nearest_loaded_point_delta_screen_y: float | None = None
    nearest_loaded_point_label_id: str = ""
    nearest_loaded_point_label_exists: bool = False
    nearest_loaded_point_label_enabled: bool = False
    nearest_loaded_point_final_visible: bool = False
    nearest_loaded_point_invisible_reason: str = ""
